...
document.addEventListener('DOMContentLoaded', function() {
    ...
    menuCategories.forEach(category => {
        category.addEventListener('click', function() {
            ...
            if (modal) {
                ...
                body.classList.add('is-scroll-disabled');
                updateModalButtons(); // Update buttons when opening modal
            }
        });
    });
    ...
    // Add event handler for delegation on modal windows
    document.addEventListener('click', function(e) {
        ...
        if (e.target.classList.contains('menu-modal__add-btn')) {
            ...
            updateCartDisplay();
            updateModalButtons(); // Update all buttons in modal windows
        ...
        // Handle quantity change buttons in modal windows
    ...
    checkoutForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
            ...
            saveCart();
            updateCartDisplay();
            updateModalButtons(); // Update buttons after clearing cart
            checkoutModal.classList.remove('active');
            checkoutForm.reset();
        } else {
            alert('Please fill in all required fields.');
    ...
    function removeFromCart(id) {
        ...
        saveCart();
        updateCartDisplay();
        updateModalButtons(); // Update buttons after removing item
    }
    ...
    function loadCart() {
        ...
        updateCartDisplay();
        updateModalButtons(); // Update buttons when loading page
    }
    ...
    // New function to update buttons in modal windows
    function updateModalButtons() {
        ...
        addToCartButtons.forEach(button => {
            ...
            if (itemInCart) {
                ...
                // Find parent element and replace button
                const parent = button.parentNode;
                parent.replaceChild(quantityControl, button);
            }
        });
        
        // Also update buttons that were already replaced with quantity controls
        ...
        quantityControls.forEach(control => {
            ...
            if (!itemInCart) {
                // If item is no longer in cart, return "Add to Cart" button
